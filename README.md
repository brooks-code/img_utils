...
* `horizontal gallery generator `: [A python script](https://github.com/brooks-code/horizontal-gallery-generator) to generate landscape‑wide galleries from pictures located within a folder *(added in Feb. 2026)*.
